...
--
-- Host: datacron.ableit.local    Database: GROUP5PRJ
-- ------------------------------------------------------
...
INSERT INTO `locations` VALUES (0,'5882 Orci Rd.','Surat','MD','51754','ALL'),(1,'5882 Orci Rd.','Surat','MD','51754','HQ'),(2,'1592 Sociis Av.','Zwolle','DE','75453','WareHouse 1'),(3,'3254 Eleifend. Ave','Anklam','CA','30587','WareHouse 2'),(4,'1901 Etiam St.','Magangu├®','TX','19261','Annex'),(5,'4036 Ipsum. Rd.','Tomohon','NJ','00286','Storage Pod');
...
INSERT INTO `user_info` VALUES (1,'TestPass'),(2,'TestPass'),(3,'TestPass'),(4,'TestPass');
...
CREATE TABLE `user_roles` (
  ...
  KEY `fk_ur2` (`role_id`),
  KEY `fk_usrloc` (`location`),
  CONSTRAINT `fk_ur1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_ur2` FOREIGN KEY (`role_id`) REFERENCES `roles` (`role_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_usrloc` FOREIGN KEY (`location`) REFERENCES `locations` (`loc_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_roles` VALUES (1,3,0),(2,3,0),(3,3,0),(4,3,0);
...
INSERT INTO `users` VALUES (1,'scott@nurvox.com','Scott','Forsyth','scott'),(2,'ryan.q.stewart@gmail.com','Ryan','Stewart','ryan'),(3,'abellmio@gmail.com','Andrew','Bellmio','andrew'),(4,'nathan.clavelli@yahoo.com','Nathan','Clavelli','nathan');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'GROUP5PRJ'
--
...
-- Dump completed on 2021-04-19 22:56:14
