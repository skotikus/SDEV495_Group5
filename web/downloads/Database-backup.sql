...
INSERT INTO `locations` VALUES (1,'5882 Orci Rd.','Surat','MD','51754','HQ',0),(2,'1592 Sociis Av.','Zwolle','DE','57575','WareHouse 1',0),(3,'3254 Eleifend. Ave','Anklam','CA','30587','WareHouse 2',0),(4,'1901 Etiam St.','MangoTown','CA','30587','Annex',0),(5,'4036 Ipsum. Rd.','Tomohon','NJ','00286','Storage Pod',0);
...
INSERT INTO `orders` VALUES (1,'6/17/2020','6/21/2020',1,5,262,4,635,0),(2,'8/23/2020','09/05/2021',3,4,92,7,669,0),(3,'11/2/2020','NULL',5,1,34,12,157,1),(4,'5/31/2020','4/8/2021',4,1,401,2,152,0),(5,'1/24/2021','9/8/2020',3,4,278,4,471,0),(8,'9/15/2020',NULL,3,4,342,NULL,18,1),(9,'5/23/2020','12/2/2020',1,5,376,5,256,0),(10,'5/3/2020','09/05/2021',2,1,420,5,214,0),(11,'6/10/2021','10/25/2020',4,3,222,4,144,0),(12,'9/16/2020','11/24/2020',1,5,126,7,422,0),(13,'10/24/2020','1/18/2021',3,4,111,12,81,0),(14,'3/6/2021','',1,3,17,1,422,1),(15,'3/30/2021',NULL,1,2,222,NULL,555,1),(16,'6/27/2020','10/4/2020',5,5,187,8,974,0),(17,'5/27/2020','09/05/2021',1,1,254,1,82,1),(18,'5/19/2020','6/24/2020',4,3,315,10,129,0),(19,'5/11/2021','NULL',2,2,93,2,66,1),(20,'1/24/2021','10/8/2020',3,2,162,5,351,0),(21,'5/28/2021','3/30/2021',5,2,405,12,349,0),(22,'2/12/2021','3/29/2021',2,1,265,1,472,1),(23,'8/11/2020',NULL,3,3,351,5,275,1),(24,'10/20/2020','09/05/2021',2,2,412,12,820,0),(25,'12/19/2020',NULL,1,3,411,NULL,711,1),(30,'3/30/2021','',3,4,222,NULL,555,1);
...
INSERT INTO `user_info` VALUES (1,'Something'),(2,'TestPass'),(3,'TestPass'),(4,'TestPass'),(5,'SomethingElse'),(6,'TestPass'),(7,'TestPass'),(8,'TestPass'),(10,'TestPass'),(11,'TestPass'),(12,'TestPass');
...
CREATE TABLE `users` (
  ...
  KEY `users_FK_1` (`loc_id`),
  KEY `users_FK` (`role_id`),
  CONSTRAINT `users_FK` FOREIGN KEY (`role_id`) REFERENCES `roles` (`role_id`),
  CONSTRAINT `users_FK_1` FOREIGN KEY (`loc_id`) REFERENCES `locations` (`loc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'scott@nurvox.com','Scott','Forsyth','scott',3,1),(2,'ryan.q.stewart@gmail.com','Ryan','Stewart','ryan',3,2),(3,'abellmio@gmail.com','Andrew','Bellmio','andrew',3,3),(4,'nathan.clavelli@yahoo.com','Nathan','Clavelli','nathan',3,4),(5,'Bstiller1@miibeian.com','Ben','Stiller','worker1',1,1),(6,'dvalett1@ucla.edu','Dallon','Valett','worker2',1,2),(7,'aquinet2@fc2.com','Ashlie','Quinet','worker3',1,3),(8,'etaffrey3@printfriendly.com','Edd','Taffrey','worker4',1,5),(10,'ahendrichs0@ycombinator.com','Allen','Hendrichs','mgr1',2,2),(11,'sdrinkel1@skype.com','Sela','Drinkel','mgr2',2,3),(12,'rkops2@yahoo.com','Robinson','Kops','mgr3',2,4);
...
-- Dump completed on 2021-05-09 21:46:36
